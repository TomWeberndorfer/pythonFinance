...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.datahi = self.datas[0].close # TODO: high
        self.datalo = self.datas[0].close # TODO: .low
        self.buy_price = 0
    ...
    def next(self):
        ...
        curr_vol = self.datavol[0]
        self.log('vol, %.2f' % curr_vol)
...
#------------------------------------------------------------
            ...
            if cur_val < self.buy_price *0.98:
