...
class ASTA_Framework:
    def __init__(self, top=None):
        ...
        self.TNotebook2.place(relx=0.0, rely=0.0, relheight=0.81, relwidth=0.99)
        ...
        self.Label2.place(relx=0.03, rely=0.04, height=21, width=113)
        ...
        self.Labelframe2.place(relx=0.0, rely=0.81, relheight=0.2, relwidth=0.97)
