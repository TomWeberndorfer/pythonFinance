...
class Framework:
    def __init__(self, top=None):
        ...
        self.TNotebook2.place(relx=0.0, rely=0.0, relheight=0.66, relwidth=0.99)
        ...
        self.Scrolledtreeview1.place(relx=0.0, rely=0.01, relheight=0.85
                                     , relwidth=0.98)
        ...
        self.ButtonRunStrategy.place(relx=0.1, rely=0.88, height=44, width=142)
        ...
        self.ButtonRunStrategyRepetitive.place(relx=0.27, rely=0.88, height=44
                                               , width=142)
        ...
        self.TPanedwindow2 = ttk.Panedwindow(self.TNotebook2_t2_page_config
                                             , orient="horizontal")
        self.TPanedwindow2.place(relx=0.0, rely=0.01, relheight=0.99
                                 , relwidth=0.99)
        self.TPanedwindow2.configure(width=200)
        self.TPanedwindow2_p1_strat_selection = ttk.Labelframe(width=-788
        ...
        self.Labelframe2.place(relx=0.0, rely=0.67, relheight=0.32
                               , relwidth=0.99)
